...
interface ITriKittyOptimized is IERC20 {
     ...
     * @param _receiver Address to send the LP tokens to. Default is msg.sender
    ...
    /**
     * @notice This withdrawal method is very safe, does no complex math since tokens are withdrawn in balanced proportions. No fees are charged.
     * @param _amount Amount of LP tokens to burn
     * @param _min_amounts Minimum amounts of tokens to withdraw
