...
/*
    forge script ./script/06_TriKittyFactorySetImplementations.s.sol:TriKittyFactorySetImplementationsScript --rpc-url <your-rpc-url> -vvv --broadcast

    --broadcast to send the tx to the network
    -vvv to see the logs
*/
contract TriKittyFactorySetImplementationsScript is Script, Consts {
    function run() public {
        uint256 deployerPrivateKey = vm.envUint(PARAM_PK_ACCOUNT);
        ITriKittyFactory _factory = ITriKittyFactory(address(0x0));
        ...
        vm.stopBroadcast();
        console.log("TriKittyFactory instance implementations set properly...");
    }
}
